          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <a href="/projects/mobile-banking" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">View Design</a>
                  <a href="/projects" className="text-gray-600 dark:text-gray-400 hover:underline text-sm">All Projects</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <a href="/projects/brand-identity" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">View Design</a>
                  <a href="/projects" className="text-gray-600 dark:text-gray-400 hover:underline text-sm">All Projects</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <a href="/projects/ecommerce" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">View Design</a>
                  <a href="/projects" className="text-gray-600 dark:text-gray-400 hover:underline text-sm">All Projects</a>
                </div>
              </div>
            </div>
