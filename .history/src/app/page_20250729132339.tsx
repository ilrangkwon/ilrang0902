      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center py-20">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
              안녕하세요! <span className="text-blue-600 dark:text-blue-400">개발자</span>입니다
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              창의적이고 사용자 친화적인 웹 애플리케이션을 만드는 것을 좋아합니다.
              새로운 기술을 배우고 문제를 해결하는 것에 열정을 가지고 있습니다.
            </p>
        ...
        <section id="about" className="py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">개발자로서의 저</h3>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full">
                  <span className="text-blue-800 dark:text-blue-200 font-medium">3+ Years Experience</span>
                </div>
                <div className="bg-green-100 dark:bg-green-900/30 px-4 py-2 rounded-full">
                  <span className="text-green-800 dark:text-green-200 font-medium">20+ Projects</span>
                </div>
                <div className="bg-purple-100 dark:bg-purple-900/30 px-4 py-2 rounded-full">
                  <span className="text-purple-800 dark:text-purple-200 font-medium">Always Learning</span>
                </div>
              </div>
            </div>
