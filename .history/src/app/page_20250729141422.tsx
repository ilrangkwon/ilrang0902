    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="projects" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">projects</h2>
