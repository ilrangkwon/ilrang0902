      ...
      <header className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md sticky top-0 z-50 border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-paperlogy">Portfolio</h1>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="text-center py-32">
          <div className="mb-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6 animate-fade-in font-paperlogy">
        ...
        <section id="about" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-paperlogy">ABOUT</h2>
        ...
        <section id="skills" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-paperlogy">SKILLS AND TOOLS</h2>
        ...
        <section id="projects" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-paperlogy">PROJECT</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="/projects/mobile-banking" className="group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors font-paperlogy">Mobile Banking App</h3>
            ...
            <a href="/projects/brand-identity" className="group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors font-paperlogy">Brand Identity Design</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <a href="/projects/ecommerce" className="group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors font-paperlogy">E-commerce Website</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <section id="contact" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-paperlogy">CONTACT</h2>
