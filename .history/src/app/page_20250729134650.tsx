        ...
        <section id="projects" className="py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Mobile Banking App</h3>
                ...
                <div className="flex gap-2">
                  <a href="#" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">View Design</a>
                  <a href="#" className="text-gray-600 dark:text-gray-400 hover:underline text-sm">Case Study</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Brand Identity Design</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 p-12 rounded-xl shadow-lg">
                 ...
                 <div className="flex items-center gap-4">
                   ...
                   <div className="flex flex-col">
                     ...
                     <a href="mailto:ilrang0902@example.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                       hello@example.com
                     </a>
                   </div>
                 </div>
