    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="skills" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Skills & Tools</h2>
        ...
        <section id="projects" className="py-32">
          <h2 className="text-4xl font-bold text-center text-gray-900 dark:text-white mb-16 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Featured Designs</h2>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Figma</span>
                    <span className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Prototyping</span>
                    <span className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">User Research</span>
                  </div>
                  <div className="flex items-center text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:underline transform group-hover:translate-x-2 transition-transform duration-300">
                    View Details →
                  </div>
                </div>
              </div>
            ...
            <a href="/projects/brand-identity" className="group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Illustrator</span>
                    <span className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Photoshop</span>
                    <span className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Brand Strategy</span>
                  </div>
                  <div className="flex items-center text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:underline transform group-hover:translate-x-2 transition-transform duration-300">
                    View Details →
                  </div>
            ...
            <a href="/projects/ecommerce" className="group">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 transform group-hover:-translate-y-4 cursor-pointer border border-gray-200/50 dark:border-gray-700/50 relative">
                ...
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Figma</span>
                    <span className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Adobe XD</span>
                    <span className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm shadow-lg transform group-hover:scale-105 transition-transform duration-300">Responsive Design</span>
                  </div>
                  <div className="flex items-center text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:underline transform group-hover:translate-x-2 transition-transform duration-300">
                    View Details →
                  </div>
